...
public:
    ...
    void StartSessionStreamCtl(const basefw::ID& sessionId, CopaCongestionCtlConfig& ccConfig,
            std::weak_ptr<SessionStreamCtlHandler> ssStreamHandler)
    {
        ...
        // cc
        m_ccConfig = ccConfig;
        m_congestionCtl.reset(new CopaCongestionContrl(m_ccConfig));
...
private:
    ...
    CopaCongestionCtlConfig m_ccConfig;
